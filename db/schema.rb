...
ActiveRecord::Schema[8.1].define(version: 2026_04_08_120000) do
  ...
  create_table "projects", force: :cascade do |t|
    ...
    t.datetime "first_shipped_at"
    t.boolean "fraud_check", default: false, null: false
    t.string "github_username"
    t.decimal "hackatime_hours", precision: 10, scale: 2, default: "0.0", null: false
    t.string "hackatime_project"
    t.json "hackatime_projects", default: [], null: false
    t.datetime "hackatime_synced_at"
    t.text "hour_justification"
    t.string "name"
  ...
  create_table "shop_items", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.text "description"
    t.decimal "dollar_per_hour", precision: 10, scale: 2
    t.string "grant_type"
    t.string "image_url"
    t.string "item_link"
  ...
  create_table "shop_orders", force: :cascade do |t|
    t.string "airtable_id"
    t.datetime "created_at", null: false
    t.decimal "dollar_per_hour_snapshot", precision: 10, scale: 2
    t.string "item_name", null: false
    t.decimal "price", precision: 10, scale: 2, null: false
  ...
  create_table "user_admin_notes", force: :cascade do |t|
    ...
    t.datetime "updated_at", null: false
    t.bigint "user_id", null: false
    t.index ["author_id"], name: "index_user_admin_notes_on_author_id"
    t.index ["user_id"], name: "index_user_admin_notes_on_user_id"
  end
  ...
  create_table "ysws_project_submissions", force: :cascade do |t|
    ...
    t.string "airtable_id"
    t.decimal "approved_hours", precision: 10, scale: 2
    t.datetime "automation_first_submitted_at"
    t.string "banner_url"
    t.string "birthday"
    t.string "city"
    t.string "code_url"
    ...
    t.bigint "project_id", null: false
    t.string "ship_status", default: "Pending", null: false
    t.string "slack_id"
    t.string "state"
    t.date "synced_at"
    t.datetime "updated_at", null: false
  ...
  add_foreign_key "user_admin_notes", "users"
  add_foreign_key "user_admin_notes", "users", column: "author_id"
