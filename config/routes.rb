...
Rails.application.routes.draw do
  ...
  post "/admin/shop/items/bulk_active", to: "admin_shop#bulk_update_items_active", as: :admin_shop_bulk_items_active
  ...
  patch "/admin/users/:id/reship_shipping", to: "admin#update_user_reship_shipping", as: :admin_user_reship_shipping
